...
class module2install(models.TransientModel):
    ...
    missing_modules_enterprise_ids = fields.One2many(comodel_name='ir.module.install_wizard.enterprise', inverse_name='wizard_id', string='Enterprise Modules', readonly=True)
    ...
    def send_form(self):
        ...
        if self.data:  # IMPORT TRIGGERED
            ...
            missing_modules = [set(wanted_ce) - set(found_modules)]
